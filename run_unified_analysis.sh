...
#SBATCH --mem=32G
#SBATCH --time 8:00:00
#SBATCH --job-name spatial-cimis-unified
#SBATCH --output unified_analysis_%j.log
#SBATCH --error unified_analysis_%j.err
...
# Run the unified analysis script with unbuffered output
echo "Starting unified Spatial CIMIS analysis..."
python -u spatial_cimis_unified.py "$CONFIG_FILE"
